...
╚═════════════════════╝"
    ...
    NewV2           = "Your Spotify version ({0}) has not been tested. The stable version for Moyx is {1}"
    ...
    NoRestore       = "Moyx has already been installed, xpui.bak not found. `nPlease uninstall Spotify client and run motify.bat again"
